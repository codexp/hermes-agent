...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("setup", "Set up a Slack channel for free-response and context cards", "Session",
               gateway_only=True, args_hint="<channel name> [type:<scope-type>] [gh:<urn>|github:<urn>] [path:<path>|dir:<path>]"),
...
#   - update: maintenance command; reached via /hermes update on Slack to stay
#     inside Slack's native slash-command cap.
_SLACK_VIA_HERMES_ONLY = frozenset({"credits", "billing", "moa", "debug", "version", "update"})
